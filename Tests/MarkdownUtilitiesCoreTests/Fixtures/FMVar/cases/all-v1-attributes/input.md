...
<fm-var src="self" query="$.published" default-zero="Unknown" default-null="Not published" type="timestamp" format="iso" locale="en-US">2026-08-29T18:29:31Z</fm-var>
<fm-list src="self" query="$.items" default-zero="No items" default-null="Items unavailable" item-type="string" format="conjunction" locale="en-US" list-style="long">one and two</fm-list>
