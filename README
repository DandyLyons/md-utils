...
1. `MarkdownUtilities`, A Swift module for parsing and manipulating Markdown content.
2. `md-utils`, A command-line tool, built on top of `MarkdownUtilities`, for performing various operations on Markdown files.
3. `markdown-utilities`, An Agent Skill that instructs LLMs to utilize the `md-utils` command-line tool for Markdown file operations.
