...
description: Update the Claude.md file. Uses best practices for CLAUDE.md files in order to improve performance.
---
...
3. **Group the rest**: Organize remaining instructions into logical categories (e.g., coding conventions, testing patterns, API design, Git workflow). For each group, create a separate markdown file.
